...
(autothemer-deftheme
 ...
 ((default                              (:background surface :foreground text))
  ...
  (org-level-1                          (:foreground text :height 1.3 :bold t))
  (org-level-2                          (:foreground text :height 1.15 :bold t))
  (org-level-3                          (:foreground text :height 1.05))
  ...
  ;; dashboard
  (dashboard-items-face								  (:weight 'light))
  (dashboard-banner-logo-title					(:weight 'bold))
  (dashboard-heading								    (:foreground subtle :weight 'heavy))
  (dashboard-no-items-face							(:foreground muted))
  (dashboard-text-banner							(:foreground muted))

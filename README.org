...
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :font "JBMono Nerd Font" :height 70)
  (set-fontset-font t nil (font-spec :size 7 :name "JBMono Nerd Font"))
  (setq-default line-spacing 0.2)
  (custom-theme-set-faces
   'user
   '(variable-pitch ((t (:family "SF Pro Display" :height 70))))
   '(fixed-pitch ((t ( :family "JBMono Nerd Font" :height 70)))))
#+END_SRC

...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-theme-set-faces
   'user
   '(variable-pitch ((t (:family "SF Pro Display" :height 90))))
...
** Eglot
:PROPERTIES:
:HEADER-ARGS:EMACS-LISP:  :noweb yes :tangle yes
:END:
...
#+BEGIN_SRC emacs-lisp :noweb yes :tangle eys
  (use-package org
    :ensure nil
    :after citar
    :general

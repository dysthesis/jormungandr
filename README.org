...
#+BEGIN_SRC emacs-lisp :tangle init.el
  (defun dysthesis/configure-font (frame)
    ...
    (remove-hook 'server-after-make-frame-functions #'dysthesis/configure-font))
  (add-hook 'server-after-make-frame-functions #'dysthesis/configure-font)
  (unless (daemonp)
